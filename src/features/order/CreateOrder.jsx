    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <input type="text" name="customer" defaultValue={username} required className="input grow-0" />
        </div>
...
export async function action({request}) {
  ...
  if (!isValidPhone(order.phone)) 
    errors.phone = "Please input a valid phone number. We might need to contact you."
